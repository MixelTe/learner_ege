...
export const Sections: Section[] = [
	{
		...
		themes: [
			...
			{ id: "ru_12p", count: 916, name: "№12 Практика", color: themes.blue, items: getItemLoader("ru_12p"), onlyAnswerInQList: true },
			...
			// { id: "ru_19p", count: 0, name: "№19 Практика", color: themes.blue, items: getItemLoader("ru_19p") },
			// { id: "ru_20p", count: 0, name: "№20 Практика", color: themes.blue, items: getItemLoader("ru_20p") },
