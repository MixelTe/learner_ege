...
export const Sections: Section[] = [
	{
		...
		themes: [
			...
			{ id: "ru_7", count: 394, name: "№7 Формы слова", color: themes.blue, items: getItemLoader("ru_7"), onlyAnswerInQList: true },
			...
			{ id: "ru_9_2", count: 633, name: "№9 Словарные слова", color: themes.blue, items: getItemLoader("ru_9_2"), onlyAnswerInQList: true },
			...
			{ id: "ru_12p", count: 908, name: "№12 Практика", color: themes.blue, items: getItemLoader("ru_12p"), onlyAnswerInQList: true },
