...
export const data = [
    ...
    new TestItemSelfCheck(13, DBc("Натуральные числа"), DBc().title("Натуральные числа").text("1,2,3...", "Ноль не является натуральным числом").text("Множество натуральных чисел обозначается ").formula(createFormulas("'N"))),
    new TestItemSelfCheck(14, DBc("Целые числа"), DBc().title("Целые числа").text("0, ±1, ±2, ±3...", "").text("Множество целых чисел обозначается ").formula(createFormulas("'Z"))),
