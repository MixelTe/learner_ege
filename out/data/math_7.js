...
export const data = [
    ...
    new TestItemSelfCheck(6, createFormulas("a@|x@| + b@|y@| = c"), DBc().svg("math_7-6.svg").formula(createFormulas("a@|x@| + b@|y@| = c")).text("", "Ромб, симметричный относительно начала координат")),
];
